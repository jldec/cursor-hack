...
export const useMenuNavigation = ({ menuRef, direction = 'horizontal' }: UseMenuNavigationProps) => {
  ...
  useEffect(() => {
    ...
    const focusableElements = Array.from(
      menuRef.current.querySelectorAll('a, button, input, textarea, select, details, [tabindex]:not([tabindex="-1"])')
    ) as HTMLElement[]
