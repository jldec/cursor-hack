    ...
    <button
      ...
      className={cn(
        'ob-focus interactive dark:bg-neutral-750 bg-neutral-250 cursor-pointer rounded-full border border-transparent p-1 transition-colors hover:bg-neutral-300 dark:hover:bg-neutral-700',
        {
          ...
          'dark:hover:bg-neutral-450 bg-neutral-900 hover:bg-neutral-700 dark:bg-neutral-500': toggled
        }
      )}
      onClick={onClick}
    >
      <div
        className={cn('aspect-square h-full rounded-full bg-white transition-all', {
