...
export const Modal = ({ className, children, clickOutsideToClose = false, isOpen, onClose }: ModalProps) => {
  ...
  return (
    <div className="fixed top-0 left-0 z-50 flex h-screen w-full items-center justify-center bg-transparent p-6">
      ...
      <Card className={cn('reveal reveal-sm relative z-50 max-w-md', className)} ref={modalRef} tabIndex={-1}>
        {children}
