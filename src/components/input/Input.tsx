...
export const Input = ({
  ...
  return preText ? (
    ...
    >
      ...
      <input
        className={cn('placeholder:text-ob-base-100 w-full bg-transparent focus:outline-none', {
      ...
      <span className="text-ob-base-200 mr-0.5 flex items-center gap-2 transition-colors select-none">{postText}</span>
    </div>
  ) : (
    <input
      className={cn(
